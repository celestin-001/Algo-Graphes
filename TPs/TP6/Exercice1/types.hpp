...
/*
 * structure représentant une coordonnées cartesienne
...
struct MatriceAdjacence {
  ...
  coordonnees *positions;// tableau à allouer de taille "ordre", représentant la position du sommet dans la fenêtre d'affichage
