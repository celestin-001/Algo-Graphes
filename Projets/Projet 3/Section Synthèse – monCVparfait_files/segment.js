...
var writeKey="WItyWn3c7gtCkrDOE6xCZQ8WFb3ZvpjS",segment_portal_name="MonCVParfait",integrations={"All":false,"Mixpanel":true,"Segment.io":true,"Webhooks":true}
"undefined"!=typeof SEGMENT_EVENTS_TO_ALL&&SEGMENT_EVENTS_TO_ALL&&(integrations={"Google Analytics":false,"Qualaroo":false,"Inspectlet":false}),APP.segment=function(e){var t=function(t){if(e.setMixpanelPropsCookie(0),"function"==typeof segmentReady&&!t)try{segmentReady()}catch(e){console.log(e)}_segmentFirePageLoadEvent&&TrackEvents("page")},n=function(e){var t={},n=JSON.parse(e)
